  ...
  function submit(values: FormValues) {
    ...
    startTransition(async () => {
      ...
      toastCudSuccess(
        ...
        mode === 'create' ? 'Jabatan berhasil ditambahkan.' : 'Jabatan berhasil diperbarui.',
      )
      onOpenChange(false)
      onSaved()
    })
    ...
    >
      <DialogContent className='sm:max-w-md'>
        <DialogHeader>
          ...
          <DialogDescription>
            {mode === 'create' ? 'Tambahkan jabatan baru ke daftar BoardRole.' : 'Perbarui nama dan urutan jabatan.'}
          </DialogDescription>
        </DialogHeader>
            ...
            <Controller
              ...
              render={({ field }) => (
                <EntityCombobox
                  ...
                  onValueChange={next => field.onChange(next ?? ROLE_PARENT_NONE)}
          ...
          <DialogFooter>
            {canDeactivate && !showDeactivateConfirm ? (
              <Button
                ...
                onClick={() => dispatchExtras({ type: 'show-deactivate-prompt' })}
              >
                Nonaktifkan
              </Button>
            ) : null}
            {canDeactivate && showDeactivateConfirm ? (
              <div className='mr-auto flex flex-wrap items-center gap-2'>
                ...
                <Button
                  ...
                  size='sm'
                  disabled={isDeactivating}
                  onClick={() => dispatchExtras({ type: 'cancel-deactivate-prompt' })}
                >
                  Batal
                </Button>
