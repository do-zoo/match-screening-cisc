...
export function RegistrationDetailTabs({ eventId, registrationId, tab, showOperasiBadge, panels }: Props) {
  ...
  return (
    ...
    >
      ...
      <TabsContent value='ringkasan' className='mt-4 w-full max-w-6xl self-center'>
        {panels.ringkasan}
      </TabsContent>
      <TabsContent value='verifikasi' className='mt-4 w-full max-w-6xl self-center'>
        {panels.verifikasi}
      </TabsContent>
      <TabsContent value='operasi' className='mt-4 w-full max-w-6xl self-center'>
        {panels.operasi}
      </TabsContent>
    </Tabs>
  )
