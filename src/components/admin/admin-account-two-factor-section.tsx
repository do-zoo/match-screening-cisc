...
export function AdminAccountTwoFactorSection({ initialTwoFactorEnabled }: { initialTwoFactorEnabled: boolean }) {
    ...
    <section className='flex flex-col gap-4 rounded-lg border bg-card p-4 md:p-6'>
      <div>
        ...
        <p className='text-sm text-muted-foreground'>
          Wajibkan kode dari aplikasi autentikator setelah kata sandi. Simpan kode cadangan di tempat aman.
        </p>
      </div>
      ...
      <Dialog open={enableOpen} onOpenChange={setEnableOpen}>
        <DialogContent className='max-h-[90vh] overflow-y-auto sm:max-w-lg'>
          <DialogHeader>
            ...
            <DialogDescription>
              Masukkan kata sandi akun Anda, lalu pindai QR dengan aplikasi autentikator (Google Authenticator,
              1Password, dll.).
            </DialogDescription>
          </DialogHeader>
      ...
      >
        <DialogContent className='sm:max-w-md'>
          <DialogHeader>
            ...
            <DialogDescription>Kode lama tidak berlaku lagi setelah Anda menyimpan yang baru.</DialogDescription>
          </DialogHeader>
          {setupError ? <p className='text-sm text-destructive'>{setupError}</p> : null}
