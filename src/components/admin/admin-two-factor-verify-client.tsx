...
export function AdminTwoFactorVerifyClient({ emailOtpAvailable }: { emailOtpAvailable: boolean }) {
  ...
  return (
    <main className='mx-auto flex w-full max-w-md flex-1 flex-col justify-center px-4 md:px-6 py-12'>
      ...
      <section className='mt-10 space-y-4 border-t pt-8'>
        ...
        <Button type='button' variant='outline' className='w-full' disabled={pending} onClick={onVerifyBackup}>
      ...
      {emailOtpAvailable ? (
        ...
        <p className='mt-8 text-xs text-muted-foreground'>
          Verifikasi lewat kode email belum diaktifkan pada lingkungan ini. Gunakan TOTP atau kode cadangan.
        </p>
      )}
    </main>
  )
