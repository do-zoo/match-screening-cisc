      ...
      {expanded && (
        <div className='border-t px-4 pb-4 pt-3 space-y-3'>
          ...
          <Controller
            ...
            render={({ field, fieldState }) => (
              <Field data-invalid={fieldState.invalid}>
                <FieldLabel htmlFor={`holder-${index}-member`}>Nomor Member CISC (opsional)</FieldLabel>
                <Input id={`holder-${index}-member`} placeholder='Kosongkan jika bukan member' {...field} />
                {fieldState.error && <FieldError errors={[fieldState.error]} />}
              </Field>
            )}
          />
