...
import { buildAdminEventsIndexUrl, parseEventsIndexSearchQuery, parseEventsIndexViewParam } from './events-index-view'
...
describe('buildAdminEventsIndexUrl', () => {
  it('includes tab view q page', () => {
    ...
    expect(buildAdminEventsIndexUrl({ tab: 'all', view: 'table', q: '  ' })).toBe('/admin/events?tab=all&view=tabel')
  })
})
