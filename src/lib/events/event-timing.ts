...
export function canEditEvent(event: Pick<EventTimingPick, 'closeRegistrationAt'>, now: Date = new Date()): boolean {
 ...
 */
export function getEventPhase(event: EventTimingPick, now: Date = new Date()): EventTimePhase {
