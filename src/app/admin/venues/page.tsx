...
import { parseVenuesIndexTab, type VenuesIndexTab } from '@/lib/admin/admin-venues-index'
...
function buildVenueWhere(tab: VenuesIndexTab, q: string): Prisma.VenueWhereInput {
...
export default async function AdminVenuesPage({
  ...
  return (
    <main className='mx-auto flex w-full max-w-6xl flex-1 flex-col gap-4 md:p-6 px-4 md:px-6 py-8 lg:py-10'>
      ...
      <AdminVenuesIndexToolbar key={`venues-idx-toolbar-${tab}-cards`} tab={tab} viewMode='cards' searchQuery={q} />
