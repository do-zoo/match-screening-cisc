  ...
  return (
    <div className='space-y-6'>
      <div>
        ...
        <h1 className='text-2xl font-semibold tracking-tight'>Template pesan WhatsApp</h1>
        <p className='text-muted-foreground mt-2 max-w-2xl text-sm leading-relaxed'>
          Mengatur teks pesan pra‑isi untuk tautan dari halaman detail pendaftaran admin. Bila Anda belum menyimpan
          suatu templat atau terjadi kesalahan, aplikasi akan memakai perilaku bawaan yang sebelumnya dihardcode dalam
          kode.
        </p>
      </div>
