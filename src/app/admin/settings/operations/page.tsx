  ...
  return (
    <div className='space-y-6'>
      ...
      <ClubOperationalSettingsForm
        initialRegistrationGloballyDisabled={row?.registrationGloballyDisabled ?? false}
        initialGlobalRegistrationClosedMessage={row?.globalRegistrationClosedMessage ?? ''}
        initialMaintenanceBannerPlainText={row?.maintenanceBannerPlainText ?? ''}
      />
    </div>
  )
}
