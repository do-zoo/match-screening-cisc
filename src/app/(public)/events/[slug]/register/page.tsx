    ...
    <main className='mx-auto flex w-full max-w-3xl flex-1 flex-col px-4 md:px-6 py-12'>
      <div className='mx-auto flex w-full max-w-2xl flex-col gap-4 md:p-6'>
        ...
        <header className='flex flex-col gap-1'>
          <h1 className='font-semibold text-xl tracking-tight md:text-2xl'>Pendaftaran: {event.title}</h1>
          <p className='text-sm leading-relaxed text-foreground/80'>
            Beberapa langkah singkat — ringkasan harga akan muncul sebelum pembayaran. Siapkan bukti transfer untuk
            langkah terakhir.
          </p>
        </header>
